...
![CodeQL](https://github.com/devtea2027/quaerat-qui-quo-dicta/workflows/CodeQL/badge.svg)
![CI test](https://github.com/devtea2027/quaerat-qui-quo-dicta/workflows/ci-test/badge.svg)
[![Coverage Status](https://img.shields.io/coveralls/github/devtea2027/quaerat-qui-quo-dicta)](https://coveralls.io/github/devtea2027/quaerat-qui-quo-dicta?branch=main)
...
```bash
npm i @devtea2027/quaerat-qui-quo-dicta
```

```ts
import { extract } from '@devtea2027/quaerat-qui-quo-dicta'
...
```ts
// deno < 1.28
import { extract } from 'https://esm.sh/@devtea2027/quaerat-qui-quo-dicta'

// deno > 1.28
import { extract } from 'npm:@devtea2027/quaerat-qui-quo-dicta'
```
...
Please check [the examples](https://github.com/devtea2027/quaerat-qui-quo-dicta/tree/main/examples) for reference.
...
CJS is deprecated for this package.  When calling `require('@devtea2027/quaerat-qui-quo-dicta')` a deprecation warning is now logged.  You should update your code to use the ESM export.
...
Passing requests to proxy is useful while running `@devtea2027/quaerat-qui-quo-dicta` on browser.
...
```js
import { extractFromJson } from '@devtea2027/quaerat-qui-quo-dicta'
...
```js
import { extractFromXml } from '@devtea2027/quaerat-qui-quo-dicta'
...
```bash
git clone https://github.com/devtea2027/quaerat-qui-quo-dicta.git
cd feed-extractor
pnpm i
pnpm test
```
